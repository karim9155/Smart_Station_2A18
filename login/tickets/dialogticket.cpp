...
void Dialogticket::on_btnAjouter_clicked()
{
    ...
    QString t_depart = ui->t_depart->currentText();
...
void Dialogticket::on_tabTicket_activated(const QModelIndex &index)
{
    ...
    QString img = "";
        ...
        if(qry.exec())
        {
            while(qry.next())
                    {
                        img = qry.value(0).toString();
                        ui->formlabel->setText(val);
                        //ui->t_depart->setText(qry.value(0).toString());
                        QPixmap pix("C:/Users/brahe/Desktop/Depart/"+img);
                        ui->label_depart->setPixmap(pix);
...
void Dialogticket::on_imageBtn_clicked()
{
    ...
    QString ville = "";
    QPdfWriter pdf("C:/Users/azert/Desktop/ticket"+t);

                      QPainter painter(&pdf);
                     int i = 4000;
                      painter.drawPixmap(QRect(-100,-100,9800,100000),QPixmap("C:/Users/azert/Desktop/image.jpg"));
                          ...
                          int reponse = QMessageBox::question(this, "Génerer Image", "<Image Enregistré>...Vous Voulez Affichez Le PDF ?", QMessageBox::Yes |  QMessageBox::No);
                              ...
                              {
                                  QDesktopServices::openUrl(QUrl::fromLocalFile("C:/Users/azert/Desktop/ticket"+t));
